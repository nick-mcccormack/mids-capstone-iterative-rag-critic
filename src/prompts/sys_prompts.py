def get_sys_prompt_resp() -> str:
	...
	return (
		...
		"OUTPUT\n"
		"- Output ONLY the answer text. Do not unnecessarily form "
...
def get_sys_prompt_critic() -> str:
	...
	return (
		...
		"Your job is to evaluate whether CURRENT_ANSWER completely "
		...
		"doc_id. CONTEXTS may be joined together from disparate sources.\n\n"
		...
		"by CONTEXTS.\n\n"
		"2) complete\n"
		"- True only if CURRENT_ANSWER completely addresses QUESTION.\n"
